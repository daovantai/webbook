...
<html lang="en">
    ...
    <body class="js">
        ...
        <section class="hero-slider">
            ...
            <a href="addbook.jsp" style="color: tomato; position: absolute; right: 10%; top:20%">Thêm sách </a>
                    ...
                    <tbody>
                        <c:forEach items="${listBook}" var="E">
                            <tr>
                                ...
                                <td>${E.namxb}</td>      
                                <td>${E.tinhtrang}</td>
                                <td class="sua"><a href="editservlet?txtiD=${E.masach}">Sửa sách</a></td>  
                                <td class="xoa"><a href="deleteservlet?txtiD=${E.masach}">Xóa sách</a></td>  
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
